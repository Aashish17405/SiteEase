...
1. **Check Existing Issues**: Look through the [issue tracker](https://github.com/Aashish17405/SiteEase/issues) to see if your issue has already been reported.
...
2. **Clone Your Fork**: Clone your forked repository to your local machine.
   ```bash
   git clone https://github.com/your-username/SiteEase.git